...
export default function Desserts({ query, setClickedRecipe }) {
  const recipes = [
    ...
    },
    {
      ...
      instructions: ["(Refer to original recipe image for interpretation)"],
    ...
    },
    {
      ...
      instructions: [
        ...
        "Lift out with 2 forks, letting excess chocolate drip off",
    ...
    },
    {
      ...
      ingredients: ["20 mini pretzels", "20 Rolos", "20 pecan halves"],
      instructions: [
    ...
    },
    {
      ...
      instructions: ["Read original recipe"],
  ...
  const ingredients = (array) => {
    return array.map((ingredient) => {
      return (
        <div className="cherry-list-item-div">
          <img
            src={SingleCherry}
            alt="cherry-bullet-point"
            className="cherry-bullet-point"
          ></img>
  ...
  return (
    <div className="dishes-div">
      <div className="grid-div" id={gridId()}>
        {recipesShown.length > 0 ? (
          dishes
        ) : (
          <h1 className="sorry-no-results">
            Sorry, no results matching "{query}"
          </h1>
        )}
      </div>
    </div>
